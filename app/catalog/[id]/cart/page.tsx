        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="text-right">
              <p className="text-lg font-semibold text-gray-900">{cart.catalogTitle}</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="border-0 shadow-xl bg-white">
              <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-t-2xl">
                <CardTitle className="text-2xl text-gray-900">Cart Items ({cart.items.length})</CardTitle>
              </CardHeader>
                ...
                {cart.items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-sm line-clamp-2 mb-3">{item.product.description}</p>
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="bg-blue-50 p-4 rounded-xl">
                  <p className="text-xs text-blue-800 text-center leading-relaxed">
                    <strong>Note:</strong> The seller will contact you directly to confirm your order, discuss payment
                    options, and arrange delivery details.
                  </p>
                </div>
              </CardContent>
            </Card>
