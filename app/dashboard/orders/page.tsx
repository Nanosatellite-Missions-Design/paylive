...
import { ArrowLeft, Package, Truck, CheckCircle, Clock, Phone, MapPin, Eye, Edit3 } from "lucide-react"
...
const mockOrders: any[] = [
  {
    ...
    catalogId: "cat1",
    catalogTitle: "Electronics Store",
    items: [
      {
        productId: "prod1",
  ...
  },
  {
    ...
    catalogId: "cat2",
    catalogTitle: "Fashion Collection",
    items: [
      {
        productId: "prod3",
  ...
  },
  {
    ...
    customerAddress: "789 Pine Rd, Village, State 13579",
    catalogId: "cat1",
    catalogTitle: "Electronics Store",
    items: [
      {
          ...
          <Card className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
            <CardContent className="p-2 md:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm hidden md:block text-yellow-700">Pending</p>
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
            <CardContent className="p-2 md:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm hidden md:block text-blue-700">On the Way</p>
          ...
          <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
            <CardContent className="p-2 md:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm hidden md:block text-green-700">Delivered</p>
          ...
          <Card className="bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200">
            <CardContent className="p-2 md:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm hidden md:block text-purple-700">Total Orders</p>
                  <p className="text-2xl font-bold text-purple-800">{userOrders.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          {userOrders.length === 0 ? (
            <Card className="p-12 text-center">
              ...
              <p className="text-gray-500">Orders from your catalogs will appear here.</p>
            </Card>
          ) : (
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                          ...
                          <div>
                            <span className="font-medium">XAF{order.total.toFixed(2)}</span>
                      ...
                      {/* Actions */}
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" onClick={() => handleViewOrder(order)} className="gap-2">
                              ...
                              const updatedOrders = userOrders.map((o) =>
                                o.id === order.id
                                  ? {
                                      ...
                                      status: nextStatus,
                                      updatedAt: new Date(),
                                    //   deliveryDate: nextStatus === "delivered" ? new Date() : o.deliveryDate,
                                    }
                                  : o,
                              )
                            //   setOrders(updatedOrders)
            ...
            {selectedOrder && (
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <Badge className={`${statusConfig[selectedOrder.status].color} gap-1 text-sm px-3 py-1`}>
                    {getStatusIcon(selectedOrder.status)}
                    {statusConfig[selectedOrder.status].label}
                  </Badge>
                  <div className="text-right">
                    <p className="text-2xl font-bold text-gray-900">XAF{selectedOrder.total.toFixed(2)}</p>
                  ...
                  <div className="space-y-3">
                    {selectedOrder.items.map((item, index) => (
                      <div key={index} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <p className="font-semibold text-gray-900">XAF{item.product.price*item.quantity}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      <Edit3 className="h-4 w-4" />
                      <span>Last Updated: {formatDate(selectedOrder.updatedAt)}</span>
                    </div>
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select value={updateStatus} onValueChange={(value: Order["status"]) => setUpdateStatus(value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
